...
import { Header, Left, Right, Body, CardItem, Container, Icon, Content, Picker, Form } from 'native-base'
import {  Card } from 'react-native-paper';//npm i react-native-paper

import Graph from './Graph';
class Statsdevice extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected: 'key1'
